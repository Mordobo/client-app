export default {
  ...
  auth: {
    ...
    accountType: {
      ...
      subtitle: "Choose how you'll use Mordobo. You can change this later from your profile.",
      clientTitle: "Find services",
      clientDesc: "Discover and hire professionals for your home.",
      providerTitle: "Offer services",
      providerDesc: "Create your profile and receive client requests.",
      switchNote: "You can switch between client and provider anytime.",
    },
  ...
  payment: {
    ...
    currencyProcessedInDop: "The charge will be processed in Dominican pesos (DOP).",
  ...
  compliance: {
    ...
    currencyNote: "All prices are shown and charged in Dominican pesos (RD$ / DOP).",
    businessDescription:
      "Dominican platform to find, book, and pay independent home-service providers.",
    linkTerms: "Terms",
    linkPrivacy: "Privacy",
    linkRefunds: "Refunds",
    linkDelivery: "Delivery policy",
    linkSecurity: "Security",
    linkServices: "Services",
    linkReceiptSample: "Receipt sample",
    servicesTitle: "Service catalog",
    currencyBanner: "Purchase currency: all prices are shown and charged in RD$ / DOP (Dominican pesos).",
    includesLabel: "Includes, among others",
    fromPrice: "From {{amount}}",
    priceNote: "Reference price in RD$. The final total is confirmed before payment.",
    receiptSampleTitle: "Payment receipt sample",
    receiptSampleIntro:
      "This is the receipt model customers receive automatically after a successful purchase on Mordobo. It includes the amount in RD$/DOP, reference, service, and masked card.",
    paymentProcessed: "Payment processed",
    receiptSecurityNote:
      "This receipt does not include the full card number or CVV. Payments are processed by AZUL.",
    needHelp: "Need help?",
    contactSupport: "Write to {{email}} or call {{phone}}.",
    email: "Email",
    whatsapp: "WhatsApp",
    back: "Back",
    lastUpdated: "Last updated: {{date}}",
    footerPrices: "{{name}} · {{address}} · All prices are expressed in Dominican pesos (RD$ / DOP).",
  },
  paymentMethods: {
  ...
  providerOnboarding: {
    ...
    business: {
      ...
      subcategoryModalTitle: "Select a specialty",
    ...
    services: {
      ...
      errorTitle: "Error saving services",
      errorAllFailed: "Could not save any services. Please try again.",
      errorPartialFailed: "{{count}} service(s) could not be saved. You can add them later from your profile.",
      missingPriceTitle: "Price required",
      missingPriceMessage: "Please add a price to all services before continuing.",
      back: "Back",
      continue: "Continue",
    },
    availability: {
    ...
    bank: {
      ...
      clabePlaceholder: "e.g., 1234567890",
      clabeHint: "Bank account number (numbers only)",
      ...
      errorClabeLength: "Account number is not valid",
  ...
  providerDashboard: {
    ...
    earnings: {
      ...
      withdrawConfirm: "Request",
      withdrawInvalidAmount: "Enter a valid amount.",
      withdrawExceeds: "Amount exceeds your available balance.",
      withdrawSuccess: "Withdrawal requested. You'll be notified when it's processed.",
      withdrawCommissionNote: "The platform commission is deducted from this amount at payout.",
      history: "History",
      periodToday: "Today",
      ...
      errors: {
        ...
        payoutsFailed: "Failed to load payouts",
      },
    },
    paymentMethods: {
      title: "Payment Methods",
