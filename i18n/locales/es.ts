export default {
  ...
  auth: {
    ...
    accountType: {
      ...
      subtitle: "Elige cómo usarás Mordobo. Puedes cambiarlo luego desde tu perfil.",
      clientTitle: "Buscar servicios",
      clientDesc: "Encuentra y contrata profesionales para tu hogar.",
      providerTitle: "Ofrecer servicios",
      providerDesc: "Crea tu perfil y recibe solicitudes de clientes.",
      switchNote: "Puedes cambiar entre cliente y proveedor cuando quieras.",
    },
  ...
  chat: {
    ...
    jobBannerYourReviewSent: "Tu calificación fue enviada",
  ...
  payment: {
    ...
    currencyProcessedInDop: "El cargo será procesado en pesos dominicanos (DOP).",
  ...
  compliance: {
    ...
    acceptedCards: "Tarjetas aceptadas",
    threeDsLabel: "3-D Secure",
    customerService: "Atención al cliente",
    currencyNote: "Todos los precios se muestran y cobran en pesos dominicanos (RD$ / DOP).",
    businessDescription:
      "Plataforma dominicana para buscar, reservar y pagar servicios de proveedores independientes.",
    linkTerms: "Términos",
    linkPrivacy: "Privacidad",
    linkRefunds: "Reembolsos",
    linkDelivery: "Política de entrega",
    linkSecurity: "Seguridad",
    linkServices: "Servicios",
    linkReceiptSample: "Modelo de recibo",
    servicesTitle: "Catálogo de servicios",
    currencyBanner: "Moneda de compra: todos los precios se muestran y cobran en RD$ / DOP (pesos dominicanos).",
    includesLabel: "Incluye, entre otros",
    fromPrice: "Desde {{amount}}",
    priceNote: "Precio referencial en RD$. El total final se confirma antes de pagar.",
    receiptSampleTitle: "Modelo de comprobante de pago",
    receiptSampleIntro:
      "Este es el modelo del recibo que el cliente recibe automáticamente después de una compra exitosa en Mordobo. Incluye monto en RD$/DOP, referencia, servicio y tarjeta enmascarada.",
    paymentProcessed: "Pago procesado",
    receiptSecurityNote:
      "Este comprobante no contiene el número completo de la tarjeta ni el código CVV. Los pagos son procesados por AZUL.",
    needHelp: "¿Necesitas ayuda?",
    contactSupport: "Escríbenos a {{email}} o comunícate al {{phone}}.",
    email: "Correo",
    whatsapp: "WhatsApp",
    back: "Volver",
    lastUpdated: "Última actualización: {{date}}",
    footerPrices: "{{name}} · {{address}} · Todos los precios se expresan en pesos dominicanos (RD$ / DOP).",
  },
  paymentMethods: {
  ...
  providerOnboarding: {
    ...
    business: {
      ...
      subcategoryModalTitle: "Selecciona una especialidad",
    ...
    services: {
      ...
      errorTitle: "Error al guardar servicios",
      errorAllFailed: "No se pudo guardar ningún servicio. Por favor intenta de nuevo.",
      errorPartialFailed: "{{count}} servicio(s) no se pudieron guardar. Puedes agregarlos después desde tu perfil.",
      missingPriceTitle: "Precio requerido",
      missingPriceMessage: "Por favor agrega un precio a todos los servicios antes de continuar.",
      back: "Atrás",
      continue: "Continuar",
    },
    availability: {
    ...
    bank: {
      ...
      clabePlaceholder: "ej., 1234567890",
      clabeHint: "Número de cuenta bancaria (solo números)",
      ...
      errorClabeLength: "El número de cuenta no es válido",
  ...
  providerDashboard: {
    ...
    ratedClientLocally: "Ya calificaste al cliente",
    ...
    earnings: {
      ...
      withdrawConfirm: "Solicitar",
      withdrawInvalidAmount: "Ingresa un monto válido.",
      withdrawExceeds: "El monto supera tu saldo disponible.",
      withdrawSuccess: "Retiro solicitado. Te notificaremos cuando se procese.",
      withdrawCommissionNote: "La comisión de la plataforma se descuenta de este monto al pagar.",
      history: "Historial",
      periodToday: "Hoy",
      ...
      errors: {
        withdrawFailed: "Error al solicitar el retiro",
        payoutsFailed: "Error al cargar los retiros",
