        ...
        >
          ...
          >
            ...
            <Text style={styles.settingsButtonText}>
              {t('providerDashboard.providerNotifications.settings')}
            </Text>
          </TouchableOpacity>
        </ScrollView>
      )}
        ...
        >
          <View style={styles.modalBox}>
            <Text style={styles.modalTitle}>
              {t('providerDashboard.providerNotifications.clearAllConfirmTitle')}
            </Text>
            <Text style={styles.modalMessage}>
              {t('providerDashboard.providerNotifications.clearAllConfirmMessage')}
            </Text>
