...
export default function ProviderOnboardingTermsScreen() {
  ...
  const [terms, setTerms] = useState<Term[]>([
    { id: "1", text: t("providerOnboarding.terms.acceptTerms"), checked: false },
    { id: "2", text: t("providerOnboarding.terms.acceptPrivacy"), checked: false },
  ...
  return (
    <View style={[styles.container, { paddingTop: insets.top }]}>
      ...
      <ScrollView style={styles.scrollView} contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false}>
        ...
        <ScrollView style={styles.termsContent} contentContainerStyle={styles.termsContentInner}>
          <View style={styles.termItem}>
            <Text style={styles.termTitle}>{t("providerOnboarding.terms.term1")}</Text>
            <Text style={styles.termDesc}>{t("providerOnboarding.terms.term1Desc")}</Text>
          </View>
          <View style={styles.termItem}>
            <Text style={styles.termTitle}>{t("providerOnboarding.terms.term2")}</Text>
            <Text style={styles.termDesc}>{t("providerOnboarding.terms.term2Desc")}</Text>
          </View>
          <View style={styles.termItem}>
            <Text style={styles.termTitle}>{t("providerOnboarding.terms.term3")}</Text>
            <Text style={styles.termDesc}>{t("providerOnboarding.terms.term3Desc")}</Text>
          </View>
          <View style={styles.termItem}>
            <Text style={styles.termTitle}>{t("providerOnboarding.terms.term4")}</Text>
            <Text style={styles.termDesc}>{t("providerOnboarding.terms.term4Desc")}</Text>
          </View>
        </ScrollView>
